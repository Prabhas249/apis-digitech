...
export default function HomeContent({ data }: { data: HomepageData }) {
  ...
  // Parse stat values for AnimatedCounter (extract number and suffix)
  ...
  return (
    <>
          ...
          <div className={`nav-menu ${mobileMenuOpen ? 'active' : ''}`}>
            ...
            >
              ...
              <div className="nav-dropdown-menu">
                ...
                <Link href="/services/web-development" className="nav-dropdown-item" onClick={() => setMobileMenuOpen(false)}>
                  <span className="dropdown-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <section className="hero">
        ...
        <div className="hero-content animate-fade-in">
          ...
          <div className="hero-cta-row">
            <Link href={data.hero.secondaryCtaLink} className="btn btn--primary btn--large">
          ...
          <div className="hero-trust">
            <span className="hero-trust-label">Trusted by {data.stats?.[0]?.label ? `${data.stats[0].value} ${data.stats[0].label.toLowerCase()}` : '500+ businesses'}</span>
        ...
        <div className="hero-form-wrapper animate-slide-up">
          <div className="hero-form-card">
            <div className="hero-form-header">
              ...
              <h2 className="hero-form-title">{data.hero.ctaText === 'Get Free Audit' ? 'Get Your Free SEO Audit' : data.hero.ctaText}</h2>
            </div>
            ...
            <form className="hero-form" onSubmit={handleSubmit} aria-label="Free SEO audit request form">
              ...
              <button type="submit" className={`hero-form-btn ${isSubmitting ? 'loading' : ''}`} disabled={isSubmitting || submitStatus === 'success'}>
                {isSubmitting ? (
                  <>
              ...
              {submitStatus === 'success' && (
                <p className="hero-form-success">We&apos;ll send your free SEO audit report shortly.</p>
              )}
              {submitStatus === 'error' && (
        ...
        <div className="why-grid">
          ...
          <div className="why-column why-column--center">
            <div className="why-visual">
              ...
              <div className="why-visual-label">{data.stats?.[0]?.value || '500+'} Projects</div>
            </div>
          </div>
      ...
      {/* Stats Section - Connected to admin data */}
          ...
          {data.stats?.map((stat, index) => {
            ...
            return (
              <div key={index} className="stat-item">
                <AnimatedCounter end={parsed.num} suffix={parsed.suffix} className="stat-number" />
      ...
      {/* CTA Section - Connected to admin data */}
      <section className="cta-section">
        ...
        <div className="cta-content">
          ...
          <div className="cta-buttons">
            <Link href={data.cta.buttonLink} className="btn btn--primary btn--large">
              {data.cta.buttonText}
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-main">
          ...
          <div className="footer-column">
            ...
            <div className="footer-contact">
              <a href="mailto:support@apisdigitech.com" className="footer-contact-item">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                  <polyline points="22,6 12,13 2,6"/>
                </svg>
        ...
        <div className="footer-bottom">
          <span className="footer-copy">&copy; 2026 Apis Digitech | All Rights Reserved.</span>
